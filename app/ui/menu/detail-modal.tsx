        ...
        <div className="p-6 max-h-[80vh] overflow-y-auto">
          ...
          <div>
              ...
              <table className="w-full text-sm text-left">
                <thead className="bg-gray-100 text-gray-600 font-medium">
                  <tr>
                    ...
                    <th className="p-3 text-left">Jumlah Pakai</th>
                    ...
                    menu.recipes.map((recipe, idx) => {
                      ...
                      return (
                        <tr key={idx} className="hover:bg-gray-50">
                          <td className="p-3 text-left text-gray-800">{recipe.stock_name}</td>
                          <td className="p-3 text-left font-bold text-pink-600">
                            {recipe.amount_needed} {recipe.unit}
                          </td>
                          <td className="p-3 text-left text-gray-700 font-semibold">
            ...
            <div className="mt-4 flex justify-start gap-2">
              ...
              <span className="font-semibold text-green-600">{formatCurrency(totalHPP)}</span>
            </div>
          </div>
